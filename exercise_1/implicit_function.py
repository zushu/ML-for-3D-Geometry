...
def signed_distance_atom(x, y, z):
    ...
    # ###############
    # TODO: Implement
    dist_proton = signed_distance_sphere(x, y, z, proton_radius, proton_center[0], proton_center[1], proton_center[2])
    dist_electron = signed_distance_sphere(x, y, z, electron_radius, electron_center[0], electron_center[1], electron_center[2])
    dist_torus = signed_distance_torus(x, y, z, orbit_radius, orbit_thickness, proton_center[0], proton_center[1], proton_center[2])
    return np.min([dist_proton, dist_electron, dist_torus], axis=0)
